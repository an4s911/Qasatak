...
timeprint("You open your eyes and realized you were sleeping, yawned and suddenly remember you had an interview today.")
...
if ch == 'a':
	...
	if ch == 'a':
		timeprint("Even then you being lazy and tired overruled your worries for getting a job and you stayed there until you heard a knock.....")
	elif ch == 'b':
		timeprint("This thought really triggered you and you jumped out of your bed only to realize that you were not in your house but rather some where so familiar...")
	elif ch == 'c':
		timeprint("You being lazy and tired didn't move an inch from the bed rather you reached over to the bedside table for the phone and dialed....")

elif ch == 'b':
	timeprint("You go worried all of a sudden and it felt like all your exhaust left your body for good. With some motivation and despite the fact that you couldn't unpause and watch the rest of your dream you jumped out of bed and checked the time. The interview already started and its 5 mins past.")
	...
	if ch == 'a':
		timeprint("You pick up your phone and search for the employer and call. It rings for some time and someone picks up from the other side, but before you could speak anything, the call is cut...")

	elif ch == 'b':
		timeprint("As you wanted that job so badly, you dress up as quickly as you can, have a snack and hurry outside but your car is missing...")
